...
<head>
    ...
    <style>
        body { background-color: #020617; color: #f8fafc; scroll-behavior: smooth; font-family: 'Inter', sans-serif; }
        .card-section { padding: 5rem 1.5rem; max-width: 72rem; margin: 0 auto; }
        .glass { background: rgba(255, 255, 255, 0.02); backdrop-filter: blur(12px); border: 1px solid rgba(255, 255, 255, 0.1); }
        .hover-card:hover { transform: translateY(-5px); border-color: #6366f1; background: rgba(99, 102, 241, 0.05); }
  ...
  <div id="skills" class="card">
     ...
     <div class="glass p-4 rounded-3xl hover-card transition-all duration-300" style="border-color: #6366f1;">
            ...
            <div class="flex gap-2 text-[10px] uppercase font-bold tracking-widest">
                <h1> mon_projet</h1>
                <span class="text-indigo-400"> <a href="mon_projet.pdf">store</a> </span>
                <span class="text-indigo-400"><a href="mon_projet.php" class="btn">Voir Projet</a></span>
            </div>
        </div>
